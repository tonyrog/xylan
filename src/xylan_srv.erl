...
init(Args0) ->
	...
	[begin
	     ...
	     ASocketOpts=xylan_lib:check_options(client,proplists:get_value(a_socket_options,ClientConf,[])),
	     BSocketOpts=xylan_lib:check_options(client,proplists:get_value(b_socket_options,ClientConf,[])),
